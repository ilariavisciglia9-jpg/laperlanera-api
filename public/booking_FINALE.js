...
function calcolaPrezzi() {
    ...
    const cleaningFee = 0; // RIPRISTINARE: era 20 (azzerato solo per test — totale deve fare 1€)
    ...
    const tax = 0; // RIPRISTINARE: era totalPersone * 3.5 * nights (azzerato solo per test — totale deve fare 1€)
